package com.example.parenttochild;
...
public class Configuration {
  ...
  private static final String CONFIGS_PROPERTY = "com.example.parenttochild.configs";
  ...
  private void postConstruct() {
    try{
      ...
      logger.error("parenttochild-backend failed to deploy", e);
